...
?>
	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class="form-group <?php echo isset($errors['region']) ? 'error': ''; ?>">
		...
		<div class="col-md-6">
			...
			<div class="form-group <?php echo isset($errors['icon']) ? 'error': ''; ?>">
				<?php echo Form::label('icon', __('Icon'), array('class' => 'control-label')) ?>
				<div class="controls">
					<?php echo Form::select('icon', $widget->icons, $widget->icon, array('class' => 'select-icons')); ?>
				</div>
			</div>

			<div class="form-group <?php echo isset($errors['show_title']) ? 'error': ''; ?>">
			...
			<div class="form-group <?php echo isset($errors['visibility']) ? 'error': ''; ?>">
			...
			<div class="form-group <?php echo isset($errors['pages']) ? 'error': ''; ?>">
			...
			<?php if ($static): ?>
				...
				<div class="form-group <?php echo isset($errors['format']) ? 'error': ''; ?>">
					<div class="controls">
