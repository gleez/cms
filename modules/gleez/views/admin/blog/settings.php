...
<?php echo Form::open($action, array('class'=>'blog-settings-form form form-horizontal')); ?>
	...
	<div class="form-group">
		...
		<div class="controls set-check">
			...
			<div class="checkbox">
				<?php echo Form::label('use_cache',         Form::checkbox('use_cache', TRUE, $use_cache).__('Enable Blog Cache')); ?>
			</div>
			
			<div class="checkbox">
				<?php echo Form::label('primary_image',     Form::checkbox('primary_image', TRUE, $primary_image).__('Use Primary Image'));?>
			</div>
