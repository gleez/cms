...
(
	...
	'The main parameters of the site set up here. The following are all of the settings that define your site as a whole: settings which determine how your site behaves, how you interact with your site, and how the rest of the world interacts with your site.' => 'Основные параметры сайта настраиваются здесь. Ниже приведены все параметры, которые определяют ваш сайт в целом: параметры, которые определяют, как ваш сайт ведет себя, как вы взаимодействуете с вашим сайтом и то, как остальной мир взаимодействует с вашим сайтом.',
