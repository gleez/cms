...
(1, 0, 0, 'Bine ai venit la Gleez - Sistem de Management al Conținutului', 'Ce este Gleez CMS?\r\n\r\nGleez CMS este un sistem prietenos de management al conținutului. Cu Gleez poți crea cu ușurința websituri dinamice in foarte scurt timp și fără a folosi altceva decât mousul! Gestionează conținutul tău web, navigația si accesul grupurilor sau a utilizatorilor in mod specific, totul de oriunde din lume folosind browserul!\r\n\r\nAvând accentul pe securitate si funcționalitate, Gleez CMS este un sistem robust si profesional potrivit pentru wesiteul oricărui business sau orgranizație. Construit pe baza limbajului de programare PHP si folosind MySQL ca bază de date, Gleez CMS oferă o performanță sporită pentru websituri de orice mărime.\r\n\r\nDescarcă:\r\n\r\nwww.gleezcms.org', 'Bine ai venit la Gleez - Sistem de Management al Conținutului', 'Ce este Gleez CMS?\r\n\r\nGleez CMS este un sistem prietenos de management al conținutului. Cu Gleez poți crea cu ușurința websituri dinamice in foarte scurt timp și fără a folosi altceva decât mousul! Gestionează conținutul tău web, navigația si accesul grupurilor sau a utilizatorilor in mod specific, totul de oriunde din lume folosind browserul!', 'publish', 0, 0, 0, 'post', 1, 1304978011, 1305488194, 1304978011, '', 0, 'en');
...
(1, 'Pagini', 'Folosește pentru a grupa pagini cu topică asemănătoare în categorii.', NULL, 'page', 0, 1, 2, 1, 1);
...
(1, 'Meniu Principal', 'main-menu', 'Meniul principal apare pe multe situri, pentru a lista secțiunile majore ale sitului, adesea în partea superioară.', NULL, NULL, '', 1, 0, 1, 18, 1, 1),
(2, 'Management', 'management', 'Meniul de management conține linkuri pentru sarcini administrative.', NULL, NULL, '', 1, 0, 1, 30, 1, 2),
(3, 'Navigație', 'navigation', 'Meniul de navigație conține linkuri destinate vizitatorilor. Unele module adaugă linkuri de navigație automat.', NULL, NULL, '', 1, 0, 1, 2, 1, 3),
(4, 'Meniu Utilizator', 'user-menu', 'Meniul Urilizator cuprinde linkuri care au legătura cu contul utilizatorului.', NULL, NULL, '', 1, 0, 1, 4, 1, 4),
(8, 'Acasă', 'home', '', 'icon-home', '', NULL, 1, 1, 2, 3, 2, 1),
(10, 'Pagini', 'pages', '', 'icon-book', 'page', NULL, 1, 1, 4, 9, 2, 1),
(11, 'Adaugă Pagină', 'add-page', '', NULL, 'page/add', NULL, 1, 10, 7, 8, 3, 1),
(12, 'Contact', 'contact', '', 'icon-envelope', 'contact', NULL, 1, 1, 18, 19, 2, 1),
(13, 'Administrează', 'administer', '', 'icon-cog', 'admin', NULL, 1, 2, 2, 3, 2, 2),
(14, 'Meniuri', 'menus', '', 'icon-bookmark', 'admin/menus', NULL, 1, 2, 6, 7, 2, 2),
(15, 'Bloguri', 'blogs', '', 'icon-beer', 'admin/blogs', NULL, 1, 2, 10, 11, 2, 2),
(16, 'Formate Input', 'input-formats', '', 'icon-magnet', 'admin/formats', NULL, 1, 2, 18, 19, 2, 2),
(17, 'Setări', 'settings', '', 'icon-cogs', 'admin/settings', NULL, 1, 2, 28, 29, 2, 2),
(18, 'Alias Căi', 'path-alias', '', 'icon-link', 'admin/paths', NULL, 1, 2, 20, 21, 2, 2),
(19, 'Widgeturi', 'widgets', '', 'icon-asterisk', 'admin/widgets', NULL, 1, 2, 26, 27, 2, 2),
(20, 'Taxonomie', 'taxonomy', '', 'icon-folder-open', 'admin/taxonomy', NULL, 1, 2, 14, 15, 2, 2),
(21, 'Etichete', 'tags', '', 'icon-tags', 'admin/tags', NULL, 1, 2, 16, 17, 2, 2),
(22, 'Module', 'modules', '', 'icon-list-alt', 'admin/modules', NULL, 1, 2, 4, 5, 2, 2),
(23, 'Utilizatori', 'users', '', 'icon-user', 'admin/users', NULL, 1, 2, 22, 23, 2, 2),
(24, 'Roluri', 'roles', '', 'icon-retweet', 'admin/roles', NULL, 1, 2, 24, 25, 2, 2),
(25, 'Pagini', 'admin-pages', '', 'icon-book', 'admin/pages', NULL, 1, 2, 8, 9, 2, 2),
(26, 'Comentarii', 'admin-comment', '', 'icon-comment', 'admin/comments', NULL, 1, 2, 12, 13, 2, 2),
(27, 'Autentificare', 'user-login', '', NULL, '', NULL, 1, 4, 2, 3, 2, 4),
(28, 'Bloguri', 'blogs-1', '', 'icon-beer', '#', NULL, 1, 1, 10, 15, 2, 1),
(29, 'Adaugă Blog', 'add-blog', '', NULL, 'blog/add', NULL, 1, 28, 13, 14, 3, 1),
(30, 'Listă', 'list', '', NULL, 'page', NULL, 1, 10, 5, 6, 3, 1),
(31, 'Listă', 'list-1', '', NULL, 'blog', NULL, 1, 28, 11, 12, 3, 1),
...
(1, 'Anonymous', 'Oaspeții pot vizualiza conținut. Oaspete este orice utilizator care nu este autentificat.', 1),
(2, 'login', 'Privilegii autentificare, confirmare cont în așteptare.', 1),
(3, 'user', 'Privilegii membrii, dupa confirmare cont.', 1),
(4, 'admin', 'Utilizator administrativ, are acces deplin.', 1);
...
(1, 'static/donate', 'Donează', 'gleez', NULL, 1, 'right', -5, 0, 0, '', '1,2', 1, 'Dacă folosești Gleez, te rugăm sa donezi ca să asiguri posibilitatea dezvoltării viitoare.', 1, 'icon-gift'),
(2, 'menu/main-menu', 'Meniu Principal', 'gleez', NULL, 1, '-1', -3, 0, 0, NULL, NULL, 1, NULL, 0, 'icon-retweet'),
(3, 'menu/management', 'Management', 'gleez', NULL, 1, 'right', -2, 0, 0, '', '4', 1, NULL, 0, 'icon-cog'),
(4, 'menu/navigation', 'Navigare', 'gleez', NULL, 0, '-1', -6, 0, 0, NULL, NULL, 1, NULL, 0, 'icon-asterisk'),
(5, 'menu/user-menu', 'Meniu Utilizator', 'gleez', NULL, 0, '-1', -5, 0, 0, NULL, NULL, 1, NULL, 0, 'icon-none'),
(6, 'admin/donate', 'Donează', 'gleez', 'fluid', 1, 'dashboard', -4, 0, 0, NULL, NULL, 1, NULL, 0, 'icon-gift'),
(7, 'admin/welcome', 'Bună', 'gleez', NULL, 1, 'dashboard', -6, 0, 0, NULL, NULL, 1, NULL, 0, 'icon-flag'),
(8, 'admin/info', 'Sistem', 'gleez', NULL, 1, 'dashboard', -3, 0, 0, NULL, NULL, 1, NULL, 0, 'icon-pushpin'),
(9, 'user/login', 'autentificare', 'user', NULL, 1, 'right', -4, 0, 0, NULL, NULL, 1, NULL, 0, 'icon-lock'),
(10, 'comment/recent', 'Comentarii', 'gleez', NULL, 0, '-1', -4, 0, 0, NULL, NULL, 1, NULL, 0, 'icon-comment'),
(11, 'admin/shortcut', 'Scurtături Rapide', 'gleez', NULL, 1, 'dashboard', -5, 0, 0, NULL, NULL, 1, NULL, 0, 'icon-bookmark'),
(12, 'blog/recent',	'Bloguri Recente',	'gleez',	NULL,	0,	'-1',	0,	0,	0,	NULL,	NULL,	1,	NULL,	1,	'icon-book'),
(13, 'blog/announce',	'Anunțuri Bloguri Recente',	'gleez',	NULL,	0,	'-1',	0,	0,	0,	NULL,	NULL,	1,	NULL,	1,	'icon-book');
