...
(
	...
	'use_captcha' => TRUE, // TRUE|FALSE
        ...
        'providers' => array(
                 ...
                 *
                 * Setup:
                 * - You must register your app with Twitter and add the information in /config/oauth.php (Oauth's config)
                 */
                'facebook' => false,
                ...
                /**
                 * Toggle Windows Live support: if set, users can log in using their windows live account.
                 *
                 * Setup:
                 * - You must register your app with Twitter and add the information in /config/oauth.php (Oauth's config)
                 */
