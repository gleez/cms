...
<div class="form-group <?php echo isset($errors['name']) ? 'has-error': ''; ?>">
	<?php echo Form::label('username', __('User name'), array('class' => 'control-label col-sm-12')) ?>
...
<div class="form-group <?php echo isset($errors['pass']) ? 'has-error': ''; ?>">
	<?php echo Form::label('password', __('Password'), array('class' => 'control-label col-sm-12')) ?>
	<div class="controls col-sm-5">
...
<div class="form-group <?php echo isset($errors['nick']) ? 'has-error': ''; ?>">
	<?php echo Form::label('nick', __('Nick name'), array('class' => 'control-label col-sm-12')) ?>
	<div class="controls col-sm-5">
...
<div class="form-group <?php echo isset($errors['mail']) ? 'has-error': ''; ?>">
	<?php echo Form::label('mail', __('Email'), array('class' => 'control-label col-sm-12')) ?>
	<div class="controls col-sm-5">
...
<div class="form-group <?php echo isset($errors['status']) ? 'has-error': ''; ?>">
	<?php echo Form::label('active', __('Status'), array('class' => 'control-label col-sm-12')) ?>
	<div class="controls col-sm-5">
