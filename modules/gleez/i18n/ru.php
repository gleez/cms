...
(
	...
	'Enter the path you wish to create the alias for, followed by the name of the new alias.' => 'Введите путь для которого вы хотите создать псевдоним, путь на который будет указывать новый псевдоним.',
	...
	'Error' => 'Ошибка',
	'Excerpt' => 'Анонс',
	'Existing URL Path' => 'Существующий URL путь',
	// F
	'Favicon' => 'Иконка',
