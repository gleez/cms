...
(8, 'Home', 'home', '', NULL, '', NULL, 1, 1, 2, 3, 2, 1),
(10, 'Pages', 'pages', '', NULL, 'page', NULL, 1, 1, 4, 7, 2, 1),
(11, 'Add Page', 'add-page', '', NULL, 'page/add', NULL, 1, 10, 5, 6, 3, 1),
(12, 'Administer', 'administer', '', NULL, 'admin', NULL, 1, 2, 2, 3, 2, 2),
(13, 'Menus', 'menus', '', NULL, 'admin/menus', NULL, 1, 2, 6, 7, 2, 2),
(14, 'Input Formats', 'input-formats', '', NULL, 'admin/formats', NULL, 1, 2, 16, 17, 2, 2),
(15, 'Settings', 'settings', '', NULL, 'admin/settings', NULL, 1, 2, 28, 29, 2, 2),
(16, 'Path Alias', 'path-alias', '', NULL, 'admin/paths', NULL, 1, 2, 18, 19, 2, 2),
(17, 'Widgets', 'widgets', '', NULL, 'admin/widgets', NULL, 1, 2, 26, 27, 2, 2),
(18, 'Taxonomy', 'taxonomy', '', NULL, 'admin/taxonomy', NULL, 1, 2, 12, 13, 2, 2),
(19, 'Tags', 'tags', '', NULL, 'admin/tags', NULL, 1, 2, 14, 15, 2, 2),
(20, 'Modules', 'modules', '', NULL, 'admin/modules', NULL, 1, 2, 4, 5, 2, 2),
(21, 'Users', 'users', '', NULL, 'admin/users', NULL, 1, 2, 20, 21, 2, 2),
(22, 'Roles', 'roles', '', NULL, 'admin/roles', NULL, 1, 2, 22, 23, 2, 2),
(23, 'Permissions', 'permissions', '', NULL, 'admin/permissions', NULL, 1, 2, 24, 25, 2, 2),
(24, 'Pages', 'admin-pages', '', NULL, 'admin/pages', NULL, 1, 2, 8, 9, 2, 2),
(25, 'Comments', 'admin-comment', '', NULL, 'admin/comments', NULL, 1, 2, 10, 11, 2, 2),
