 ...
 */
Gleez.tableDrag = function (table, tableSettings) {
  var self = this;
 ...
 */
Gleez.tableDrag.prototype.initColumns = function () {
 ...
 * Undo showColumns().
 */
Gleez.tableDrag.prototype.hideColumns = function () {
  ...
  // Change link text.
  $('.tabledrag-toggle-weight').text('Show row weights');
 ...
 * Undo hideColumns().
 */
Gleez.tableDrag.prototype.showColumns = function () {
  ...
  // Change link text.
  $('.tabledrag-toggle-weight').text(Gleez.t('Hide row weights'));
  // Change cookie.
  $.cookie('Gleez.tableDrag.showWeight', 1, {
    path: Gleez.settings.basePath,
 ...
 */
Gleez.tableDrag.prototype.rowSettings = function (group, row) {
  var field = $('.' + group, row);
 ...
 */
Gleez.tableDrag.prototype.makeDraggable = function (item) {
  var self = this;
 ...
 */
Gleez.tableDrag.prototype.dragRow = function (event, self) {
  if (self.dragObject) {
 ...
 */
Gleez.tableDrag.prototype.dropRow = function (event, self) {
 ...
 */
Gleez.tableDrag.prototype.mouseCoords = function (event) {
 ...
 */
Gleez.tableDrag.prototype.getMouseOffset = function (target, event) {
 ...
 */
Gleez.tableDrag.prototype.updateFields = function (changedRow) {
  for (var group in this.tableSettings) {
 ...
 */
Gleez.tableDrag.prototype.updateField = function (changedRow, group) {
 ...
 * may have had.
 */
Gleez.tableDrag.prototype.copyDragClasses = function (sourceRow, targetRow, group) {
...
Gleez.tableDrag.prototype.checkScroll = function (cursorY) {
...
Gleez.tableDrag.prototype.setScroll = function (scrollAmount) {
  var self = this;
...
Gleez.tableDrag.prototype.restripeTable = function () {
 ...
 */
Gleez.tableDrag.prototype.onDrag = function () {
  return null;
};
 ...
 */
Gleez.tableDrag.prototype.onDrop = function () {
  return null;
};
 ...
 */
Gleez.tableDrag.prototype.row = function (tableRow, method, indentEnabled, maxDepth, addClasses) {
 ...
 *   Whether we want to add classes to this row to indicate child relationships.
 */
Gleez.tableDrag.prototype.row.prototype.findChildren = function (addClasses) {
 ...
 */
Gleez.tableDrag.prototype.row.prototype.isValidSwap = function (row) {
  if (this.indentEnabled) {
    var prevRow, nextRow;
 ...
 */
Gleez.tableDrag.prototype.row.prototype.swap = function (position, row) {
  Gleez.detachBehaviors(this.group, Gleez.settings, 'move');
  $(row)[position](this.group);
  Gleez.attachBehaviors(this.group, Gleez.settings);
  this.changed = true;
  this.onSwap(row);
};
 ...
 */
Gleez.tableDrag.prototype.row.prototype.validIndentInterval = function (prevRow, nextRow) {
 ...
 */
Gleez.tableDrag.prototype.row.prototype.indent = function (indentDiff) {
 ...
 */
Gleez.tableDrag.prototype.row.prototype.findSiblings = function (rowSettings) {
  var siblings = [];
 ...
 */
Gleez.tableDrag.prototype.row.prototype.removeIndentClasses = function () {
 ...
 */
Gleez.tableDrag.prototype.row.prototype.markChanged = function () {
 ...
 */
Gleez.tableDrag.prototype.row.prototype.onIndent = function () {
  return null;
};
 ...
 */
Gleez.tableDrag.prototype.row.prototype.onSwap = function (swappedRow) {
  return null;
};
