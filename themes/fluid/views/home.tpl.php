<?php defined("SYSPATH") or die("No direct script access.") ?>
    ...
    <div class="hero-unit">
        ...
        <blockquote>
            ...
            <small>With an emphasis on security and functionality, Gleez is a professional and robust system suitable for any business or organization. Built on the PHP programming language and the MySQL database, Gleez delivers superb performance on any size application.</small>
        </blockquote>
        <p>
            <a class="btn download btn-large" href="https://github.com/gleez/cms/">Download on GitHub</a>
            <a class="btn btn-large" href="/guide/gleez/gleez.introduction/">Get started →</a>
        </p>
    </div>
