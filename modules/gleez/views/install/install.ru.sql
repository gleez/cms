...
(2, 'Блоги', 'Используйте для группировки материалов блогов на схожие темы в категории.', NULL, 'blog', 0, 3, 4, 1, 1);
...
(1, 'guest', '', 'guest@example.com', 'Гость', NULL, 0, '', '', NULL, 0, 0, 0, 0, 1, 'UTC', 'en_US', '', '', NULL, NULL),
(2, 'admin', 'f06b94fb0479f5596399aa962d9d9f8904d3e09a', 'webmaster@gleez.com', 'Администратор', NULL, 0, '', '', NULL, 12, 1304109999, 1305386005, 1305386005, 1, 'UTC', 'en_US', '', 'webmaster@gleez.com', NULL, NULL);
...
(10, 'Страницы', 'pages', '', 'icon-file', 'page', NULL, 1, 1, 4, 9, 2, 1),
(11, 'Добавить страницу', 'add-page', '', NULL, 'page/add', NULL, 1, 10, 7, 8, 3, 1),
