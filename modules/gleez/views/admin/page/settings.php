...
<div class="help">
	<?php echo __('Page specefic settings, default status, tags, comments etc.'); ?>
</div>
...
<div class="control-group <?php echo isset($errors['comment_default_mode']) ? 'error': ''; ?>">
	...
	<?php echo Form::label('comment_default_mode', Form::radio('comment_default_mode', 3, $mode3).__('Threaded list - expanded'), array('class' => 'radio')) ?> 
...
<div class="control-group <?php echo isset($errors['comment_order']) ? 'error': ''; ?>">
        ...
        <?php echo Form::select('comment_order', array('asc'=> __('Older'), 'desc'=>__('Newer')),
            isset($post['comment_order']) ? $post['comment_order'] : 'asc', array('class' => 'select tiny'));
        ?><br />
        <?php echo Form::label('comment', __('Comments should be displayed with the older/new comments at
                                             the top of each page'), array('class' => 'control-label')) ?>
</div>
...
<div class="control-group <?php echo isset($errors['comments_per_page']) ? 'error': ''; ?>">
	...
	<?php echo Form::select('comments_per_page', array(5 =>5, 10 => 10, 20 => 20, 30 => 30, 50 => 50, 70 => 70,
                    90 => 90, 150 => 150, 200 => 200, 250 => 250, 300 => 300), isset($post['comments_per_page'])
                    ? $post['comments_per_page'] : 50, array('class' => 'select tiny'));
        ?>
</div>
