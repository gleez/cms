...
class Controller_User extends Template {
	...
	public function action_profile()
	{
		...
		{
			$this->request->redirect('user/' . $this->_auth->get_user()->id);
		}
	}
	...
	public function action_view()
	{
		...
		{
			throw new HTTP_Exception_404('Attempt to access non-existent profile.');
		}

		$this->response->body( View::factory('user/profile')->set('account', $user)->set('user', $account) );
	}
	...
	public function action_reset_confirm_password()
	{
		...
		$view = View::factory('user/confirm_reset_password')->bind('post', $post)->bind('errors', $errors);
