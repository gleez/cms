...
return array
	...
	'The Menu wizard provides an interface for managing menus. A menu is a hierarchical collection of links, which can be within or external to the site, generally used for navigation.' => 'Меню мастер предоставляет интерфейс для управления меню. Меню представляет собой иерархическую коллекцию ссылок, которые могут быть внутри, так и внешними по отношению к сайту, как правило, используется для навигации.',
