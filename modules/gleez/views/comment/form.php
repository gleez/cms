		...
		<div class='inside' id="submitpost">
			<div id="minor-publishing">
				...
				<div class="control-group <?php echo isset($errors['author_name']) ? 'error': ''; ?>">
					...
					<?php echo Form::input('author_name', $post->user->name,array('class' => 'text large'),
										'autocomplete/user'); ?>
				</div>
				<div class="control-group <?php echo isset($errors['author_date']) ? 'error': ''; ?>">
					...
					<?php echo Form::input('author_date', Gleez::date_time($post->created), array('class' => 'text large')); ?>
				</div>
			</div>
			...
			<div id="major-publishing-actions">
				<?php if( $post->loaded() ):?>
					<div id="delete-action">
						<?php echo HTML::anchor($post->delete_url.URL::query($destination), _('Move to Trash'), array('class' => 'submitdelete deletion')) ?>
					</div>
				<?php endif; ?>
	...
	<div id="submitdiv" class="stuffbox">
		...
		<div class="inside">
			<div class="control-group <?php echo isset($errors['guest_name']) ? 'error': ''; ?>">
				<?php echo Form::label('guest_name', __('Name'), array('class' => 'nowrap') ) ?>
	...
	<div id="postdiv" class="postarea <?php echo isset($errors['body']) ? 'error': ''; ?>">
		...
		<div class="inside">
			<div class="control-group <?php echo isset($errors['body']) ? 'error': ''; ?>">
				...
				<?php //echo Form::label('content', __('Leave a comment'), array('class' => 'nowrap') ) ?>
