...
?>
	...
	<div class="row-fluid">
		<div class="span6">
			...
			<div class="control-group <?php echo isset($errors['status']) ? 'error': ''; ?>">
				...
				<?php echo Form::label('status', __('Enabled:'), array('class' => 'control-label')) ?>
				<div class="controls">
					<?php echo Form::label('enabled', Form::radio('status', 0, $enabled_off).__('Disabled'), array('class' => 'radio inline')) ?>
	...
	<?php echo Form::submit('widget', __('Submit'), array('class' => 'btn btn-primary btn-large')) ?>
<?php echo Form::close() ?>
