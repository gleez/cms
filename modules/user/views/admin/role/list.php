...
<?php else:?>
	...
	<?php echo HTML::anchor($add_url, '<i class="icon-plus icon-white"></i> '.__('Add New Role'), array('class' => 'btn btn-danger pull-right')); ?>
	<div class="clearfix"></div><br>

	<table id = "admin-list-paths" class="table table-striped table-bordered" data-toggle="datatable" data-target="<?php echo $url?>" data-sorting='[["0", "desc"]]'>
		<thead>
		<tr>
