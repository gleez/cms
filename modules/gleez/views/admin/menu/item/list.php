...
<?php echo HTML::anchor(Route::get('admin/menu/item')->uri(array('action' => 'add', 'id' => $id)), '<i class="icon-plus icon-white"></i>'.__('Add New Item'), array('title'=>__('Add New Item'), 'class' => 'btn btn-primary pull-right')); ?>
<div class='clearfix'></div><br/>
	...
	<?php echo Form::submit('menu-item-list', __('Save'), array('class'=>'btn btn-success')); ?>
	<?php echo Form::close(); ?>